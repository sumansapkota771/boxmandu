export default function BlogHero() {
  return (
    <section className="pt-32 pb-20 bg-gradient-to-br from-white via-golden/5 to-white">
      <div className="container mx-auto px-4">
        <div className="text-center space-y-6">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-golden/20 to-golden/10 rounded-full border border-golden/30">
            <span className="text-golden font-semibold">Boxing Blog</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Stay updated with the latest boxing techniques, training tips, nutrition advice, and community news from
            BoxMandu.
          </p>
        </div>
      </div>
